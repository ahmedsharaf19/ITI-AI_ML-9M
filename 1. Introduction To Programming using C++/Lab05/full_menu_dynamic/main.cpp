...
Employee newEmployee(Employee Employees[], int numValidEmp, int maxEmployees);
...
int main() {
    int maxEmployees;
    cout << "\t\t----------------- Welcome In My Menu Porgram ------------------\n\n";
    ...
    do {
        ...
        case ENTER:
            ...
            if (highlightIndex == NEW) {
                if (numValidEmp < maxEmployees) {
                    Employees[numValidEmp] = newEmployee(Employees, numValidEmp, maxEmployees);
                    numValidEmp++;
                } else {
...
Employee newEmployee(Employee Employees[], int numValidEmp, int maxEmployees) {
    ...
    do{
        cout << "\tNew ID: ";
        cin >> newEmp.id;
        flag = checkId(Employees, newEmp.id, maxEmployees - numValidEmp);
        if(!flag){
